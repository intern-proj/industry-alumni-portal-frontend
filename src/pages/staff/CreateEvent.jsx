    ...
    <div className="max-w-5xl mx-auto space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-slate-500">Configure event details, sessions, and guest lectures.</p>
        </div>
        <Button variant="ghost" onClick={() => navigate('/staff/events')}>Cancel</Button>
      </div>
          ...
          <CardContent className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-1">
                ...
                <Input name="title" value={eventData.title} onChange={handleEventChange} placeholder="e.g. Full-Stack Web Development Bootcamp" required />
              </div>
              <div className="space-y-1">
